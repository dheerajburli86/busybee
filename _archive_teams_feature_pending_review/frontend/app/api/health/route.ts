...
const SCHEMA: [string, string, string][] = [
  ["Tasks", "tasks", "id, desk_id, project_id, stage_id, title, description, priority, status, progress_percent, due_date, start_date, completed_at, assigned_to, created_by, task_manager_id, milestone, milestone_id, team_id, key_result_id, progress_type, progress_target, progress_current, archived_at, personal, remind_at, remind_to, reminder_sent_at, created_at, updated_at"],
  ["Checklist items", "subtasks", "id, task_id, title, done, progress_percent, position, assigned_to, team_id, due_date, progress_type, progress_target, progress_current, created_by, created_at, updated_at"],
  ...
  ["People on the desk", "desk_members", "desk_id, user_id, role, department_id"],
  ["Profiles", "users", "id, email, full_name, created_at"],
  ["Project members", "project_members", "id, project_id, user_id, role"],
  ["Departments", "departments", "id, desk_id, name, created_by, created_at"],
  ["Teams and groups", "teams", "id, desk_id, name, kind, department_id, manager_id, created_by, created_at"],
  ["Team members", "team_members", "id, team_id, user_id, added_at"],
  ["Milestones", "milestones", "id, project_id, name, due_date, position, created_by, created_at"],
