...
//
// Checklist #46: folders that organize the document library. Folders
// themselves are desk-wide (anyone can browse the tree); the documents
// inside a folder carry their own visibility (#47), enforced separately.
